...
&nbsp; 🚀 &nbsp; Currently mastering **Node.js**, **React**, **Next.js** & **Google Cloud**

&nbsp; 🤖 &nbsp; Building **AI-powered apps** using RAG & LLMs

&nbsp; 🗄️ &nbsp; Deep interest in **Databases**, **APIs** & **System Design**

&nbsp; 🐧 &nbsp; **Linux** & Self-hosting Enthusiast

&nbsp; 🌐 &nbsp; Love deploying & experimenting with **backend infrastructure**

&nbsp; 📡 &nbsp; Exploring **IoT** with ESP32 & MQTT

&nbsp; 🎮 &nbsp; Occasionally developing games with **Unity**
